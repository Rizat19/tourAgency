    ...
    public class Tour
    {
        ...
        public double tourPricePerson()
        {
            ...
            if (countPerson <= 5)
            {
               // скидка жасау формуласы
                tourPrice = countPerson * country.Price * (1.05 - (5.0 * countPerson) / 100.0); //егер countperson = 1 болса, 1.05-0.05=1 ,
                                                                                                //яғни ешқандай скидка болмайды
            }
            else
            {
        ...
        public string toStringTour()
        {
            ...
            return "Country :" + this.country.CountryName + " ;tour price :" + this.tourPrice+
                   " ;tour dateStart :"+this.dateStart+" ;tour dateFinish :"+this.dateFinish;
        }
    }
}